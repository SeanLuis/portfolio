::LabCard{title="Smart Contract Interactivo" description="Visualiza y simula interacciones con un smart contract básico" :showUsageTab=true}
...
```vue
<template>
  <div class="p-5 bg-gray-100 dark:bg-gray-900 rounded-lg border dark:border-gray-700">
    <!-- Contract Panel -->
    <div class="mb-4">
